...
1. **Code zip** — zip `code/`, `README.md`, `problem_statement.md`, and `AGENTS.md`. Exclude `venv/`, `__pycache__/`, `.env`, and generated CSVs.
2. **Predictions CSV** — your final `output.csv` for all rows in `dataset/claims.csv`.
3. **Chat transcript** — the `log.txt` from the path above.
